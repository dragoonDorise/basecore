...
function modal() {
  ...
  var modal = function () {
    ...
    var show = function show(el) {
      ...
      var body = document.querySelector("body"); //Start Event

      if (window.CustomEvent) {
        event = new CustomEvent(startEvent, {
          detail: {
            some: "data"
          }
        });
        ...
        event.initCustomEvent(startEvent, true, true, {
          some: "data"
        });
      }
      ...
      el.setAttribute("aria-hidden", "false"); //Ending Event

      if (window.CustomEvent) {
        event = new CustomEvent(endEvent, {
          detail: {
            some: "data"
          }
        });
        ...
        event = document.createEvent("CustomEvent");
        event.initCustomEvent(endEvent, true, true, {
          some: "data"
        });
      }
    ...
    var hide = function hide(el) {
      ...
      var endEvent = "bc.is.hidden"; //Start Event
